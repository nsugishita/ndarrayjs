...
module.exports._set_alias = function(np) {
    np.load = module.exports.load;
};

// Return a string of a given binary array of char codes.
var array_to_string = module.exports.array_to_string = function(array, length) {
    if (length == undefined) {
        length = array.length;
    }
    var result = "";
...
var parse_binary = module.exports.parse_binary = function(arraybuffer) {
