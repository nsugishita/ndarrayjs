(function (root, definition) {
     ...
     */
    var _buffer_pointer = exported._buffer_pointer = function(array) {
    ...
    var accessor_impl = function(a, index, value) {
        ...
        if (is_advanced_indexing && is_getter) {  // advanced getter
            pointer = exported._apply_advanced_indexing(a, index);
     ...
     */
    var _apply_basic_indexing = exported._apply_basic_indexing = function(a, index){
        /*
    ...
    };  // exported._apply_basic_indexing

    exported._apply_advanced_indexing = function(a, index){
        ...
        var original_pointer = exported._buffer_pointer(a);
        ...
        return new_pointer;
    };  // exported._apply_advanced_indexing
    var _apply_advanced_indexing = exported._apply_advanced_indexing;
