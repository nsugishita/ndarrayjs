(function (root, definition) {
     ...
     */
    var _merge_dims = exported._merge_dims = function(a) {
        var i, n = a.ndim;
     ...
     */
    var _get_reshaped_stride = exported._get_reshaped_stride = function(a, shape) {
    ...
    var flatten = exported.flatten = function(a) {
        return exported.reshape(a, a.size);
    };  // np.flatten

    // Flatten a given array and return its view or copy.
    var ravel = exported.ravel = exported.flatten;
