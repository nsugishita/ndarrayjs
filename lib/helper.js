...
// globally module.exports, namely available as np.xxx as well as np.helper.xxx.
var globally_exported = {};

module.exports._set_alias = function(np) {
    var key;
    for (key in globally_exported) {
        np[key] = globally_exported[key];
    }
};
 ...
 */
module.exports.msieversion = (function() {
...
module.exports.is_array_buffer_supported =
    (module.exports.msieversion == 0 || module.exports.msieversion >= 10);
 ...
 * @returns {boolean}
 */
var use_arraybuffer_current_mode = module.exports.is_array_buffer_supported;
module.exports.use_arraybuffer = function(value) {
    if (value === undefined) {
 ...
 * @returns {object[]}
 */
module.exports.get_nested_array_shape = function(array, options) {
    options = options || {};
...
if (module.exports.msieversion > 0) {
    /**
     * Determine whether the passed value is a TypedArray.
     */
    module.exports.isTypedArray = function(value) {
        // This is not very precise test but anyway...
        return module.exports.is_array_buffer_supported &&
...
globally_exported.nan = NaN;
globally_exported.inf = Infinity;
globally_exported.None = null;
 ...
 * @returns {Boolean}
 */
globally_exported.isnumber = function(value) {
 ...
 * @returns {Boolean}
 */
globally_exported.isnan = Number.isNaN || function(value) {
    return value !== value;
};  // isnan
 ...
 * @returns {Boolean}
 */
globally_exported.isfinite = Number.isFinite || function(value) {
 ...
 * @returns {Boolean}
 */
globally_exported.isinf = function(value) {
    return (
 ...
 */
module.exports.isinteger = Number.isInteger || function(value) {
    return typeof value === 'number' &&
            isFinite(value) &&
 ...
 */
module.exports.isbinary = function(value, allow_bool) {
    if (allow_bool)
...
module.exports.ispositive = function(value) {
    return module.exports.isnumber(value) && (value > 0);
};  // ispositive

/**
 * Determine whether the passed value is a nonnegative number, including np.inf.
 */
module.exports.isnonnegative = function(value) {
    return module.exports.isnumber(value) && (value >= 0);
};  // isnonnegative
 ...
 */
module.exports.isbigint = function(value) {
 ...
 * @returns {Number} i
 */
module.exports.trunc = Number.trunc || function(v) {
    return v < 0 ? Math.ceil(v) : Math.floor(v);
};  // module.exports.trunc

var is_float_array = module.exports.is_float_array = function(a) {
    return (Array.isArray(a) && Array.prototype.every.call(a, module.exports.isnumber));
};

var is_boolean_array = module.exports.is_boolean_array = function(a) {
    return (Array.isArray(a) && Array.prototype.every.call(a, module.exports.isbool));
};

var is_binary_array = module.exports.is_binary_array = function(a) {
    return (Array.isArray(a) && Array.prototype.every.call(a, module.exports.isbinary));
};

var is_integer_array = module.exports.is_integer_array = function(a) {
    return (Array.isArray(a) && Array.prototype.every.call(a, module.exports.isinteger));
};
 ...
 */
var default_stride = module.exports.default_stride = function(shape) {
    var stride = [];
    var buf = 1;
    var i;
 ...
 * @returns {iterator}
 */
var iterator_from_shape = module.exports.iterator_from_shape = function(shape) {
    var value = [];
    var i;
...
var jsarray = module.exports.jsarray = {};

jsarray.allpositive = function(array) {
    return Array.prototype.every.call(array, module.exports.ispositive);
};

jsarray.allnonnegative = function(array) {
    return Array.prototype.every.call(array, module.exports.isnonnegative);
};
 ...
 * @param {ArrayLike} a - array to be indexed/sliced.
 * @param {(int[]|string[]|ArrayLike[])} index - index.
 ...
 * @param {this} Value to use as this when executing mapFn.
...
})();  // module.exports.jsarray.from

for (var key in globally_exported)
    module.exports[key] = globally_exported[key];
